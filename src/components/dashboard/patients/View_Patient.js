        ...
        <SafeAreaView style={tailwind('bg-white h-full')}>
            ...
            <View style={tailwind('mt-3')}>
                ...
                <View style={ tailwind('flex flex-row justify-between w-11/12 self-center') }>
                    ...
                    <TouchableOpacity onPress={() => { props.navigation.reset({ index: 1,routes: [{ name: 'Add_Patient' }],}); }}>
            ...
            <ScrollView style={styles.scrollView}>
                ...
                {   list.map((item,index) => { 
                    return(
                    <View style={[tailwind('mt-10 bg-gray-50 rounded-2xl w-11/12 self-center py-6'),
                    { 
                        shadowColor: "black",
                        ...
                        <View style={tailwind('flex flex-row w-11/12 ml-5 pb-6')}>
                            ...
                            {/* <TouchableOpacity style={tailwind('w-1/12 border border-gray-300 w-5 h-5 items-center rounded-md ')}></TouchableOpacity> */}
                            ...
                            <View style={tailwind('flex flex-row ml-5')}>
                                ...
                                <View style={tailwind('flex flex-col ml-3')}>
                                    <Text style={tailwind('font-bold text-black text-base')} numberOfLines={1} ellipsizeMode="tail" >{item.name}</Text>
                        ...
                        <TouchableOpacity 
                            onPress={() => { props.navigation.reset({ index: 1,routes: [{ name: 'Edit_Patient' , patient_details : item }],}); }}
                ...
                <TouchableOpacity
                onPress={() => { props.navigation.reset({ index: 1,routes: [{ name: 'Add_Patient' }],}); }}
                style={[tailwind('mt-10 bg-gray-50 rounded-2xl w-11/12 self-center items-center py-6'),
                { 
                    shadowColor: "black",
                    shadowOffset: { width: 0, height: 4 },
                    shadowRadius: 6,
                    ...
                    <Image style={tailwind('w-14 h-14')} source={require('../assets/icon/patient.png')} />
                    <Text style={tailwind('text-gray-400 font-normal py-3')}>Add New Patient</Text>
                </TouchableOpacity>
            ...
            { patient_list.length != 0 ?
                ...
                <TouchableOpacity onPress={() => addMessage()}
                    ...
                    <Text style={tailwind('text-white font-bold py-3')}>Request</Text>
