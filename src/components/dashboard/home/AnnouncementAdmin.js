        ...
        <SafeAreaView style={tailwind('h-full  bg-white ')}>
            ...
            <View style={tailwind('mt-3')}>
                ...
                <View style={ tailwind('flex flex-row justify-around') }>
                    ...
                    <TouchableOpacity onPress={() => { props.navigation.reset({ index: 4,routes: [{ name: 'Dashboard' }] }); }}>
                    ...
                    <TouchableOpacity onPress={() => { props.navigation.reset({ index: 1,routes: [{ name: 'CreateAnnouncement' }],}); }}>
                        <Image style={tailwind('w-8 h-8 mt-4')} source={require('../assets/icon/edit.png')} />
                    </TouchableOpacity>
            ...
            <ScrollView style={styles.scrollView}>
                ...
                { list.map((todo,index) => 
                    ...
                    <View style={tailwind('mt-2 w-11/12 self-center py-6 justify-center border-b border-gray-200')} key={index}>
                        ...
                        <TouchableOpacity onPress={() => { props.navigation.reset({ index: 5,routes: [{ name: 'AnnouncementDetailsAdmin' , doc_id : todo.doc_id  }],}); }}>
